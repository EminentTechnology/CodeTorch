...
$(function () {
    ...
    $(".card-footer").append("<input type='button' name='ctl00$MainContent$Buttons$Save' value='Add Card' onclick='stripecheck();' id='MainContent_Buttons_Save' class='btn btn-primary btn-block mt-4'>");

    $("#MainContent_Add_your_payment_method_AccountName_ctrl").attr("placeholder", "Enter your name as shown on your card - eg John Doe");
