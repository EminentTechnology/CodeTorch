using System;
using System.Linq;
using CodeTorch.Mobile.Data.Rest.iOS;
using Newtonsoft.Json;

[assembly: Xamarin.Forms.Dependency(typeof (iOSRestClient))]
namespace CodeTorch.Mobile.Data.Rest.iOS
{
    public class iOSRestClient: IRestClient
    {
