...
namespace CodeTorch.Core
{
    ...
    public class App
    {
		...
		public string SettingProviderAssembly { get; set; }
		public string SettingProviderClass { get; set; }
		public string SettingProviderConfig { get; set; }
        ...
        public static App Populate(XDocument doc)
        {
            ...
            {
                throw new Exception(String.Format("Error occurred while processing App - {0}", doc.Root.FirstNode.ToString()), ex);
            }
            return item;
        }
