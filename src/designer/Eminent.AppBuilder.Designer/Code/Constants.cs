...
namespace CodeTorch.Designer
{
    public class Constants
    {
        ...
        public const string ENTITY_TYPE_APP_FOLDER = "App";//
        public const string ENTITY_TYPE_CONTROL_TYPE_FOLDER = "ControlTypes";//
        public const string ENTITY_TYPE_SCREEN_TYPE_FOLDER = "ScreenTypes";//
        public const string ENTITY_TYPE_SCREEN_FOLDER = "Screens";
        public const string ENTITY_TYPE_DASHBOARD_COMPONENT_FOLDER = "DashboardComponents";
        public const string ENTITY_TYPE_DATA_COMMAND_FOLDER = "DataCommands";
        public const string ENTITY_TYPE_GROUP_FOLDER = "Groups";
        public const string ENTITY_TYPE_LOOKUP_FOLDER = "Lookups";
        public const string ENTITY_TYPE_MENU_FOLDER = "Menus";
        public const string ENTITY_TYPE_PAGE_TEMPLATE_FOLDER = "PageTemplates";
        public const string ENTITY_TYPE_PERMISSION_FOLDER = "Permissions";
        public const string ENTITY_TYPE_PICKER_FOLDER = "Pickers";
        public const string ENTITY_TYPE_SEQUENCE_FOLDER = "Sequences";
        public const string ENTITY_TYPE_TEMPLATE_FOLDER = "Templates";
        public const string ENTITY_TYPE_WORKFLOW_FOLDER = "Workflows";
