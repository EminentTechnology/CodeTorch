...
{
    public class SequenceConfigurationObject: IConfigurationObject2, IConfigurationManager<Sequence>
    {
        ...
        Sequence IConfigurationManager<Sequence>.Load(XDocument doc, string path)
        {
            return Sequence.Load(doc);
        }
    }
}
