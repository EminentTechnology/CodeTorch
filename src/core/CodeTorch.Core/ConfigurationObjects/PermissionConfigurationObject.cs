...
{
    public class PermissionConfigurationObject: IConfigurationObject2, IConfigurationManager<Permission>
    {
        ...
        Permission IConfigurationManager<Permission>.Load(XDocument doc, string path)
        {
            return Permission.Load(doc);
        }
    }
}
