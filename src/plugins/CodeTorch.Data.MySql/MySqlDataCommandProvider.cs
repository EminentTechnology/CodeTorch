...
{
    public class MySqlDataCommandProvider : DataLayerBase, IDataCommandProvider
    {
        ...
        public DataTable GetStoredProcedureParameters(DataConnection connection, DbTransaction tran, string SPName)
        {
            ...
            */
            ...
            string commandText = @"SELECT 
	                                    ...
	                                    ORDINAL_POSITION colorder,
	                                    DATA_TYPE ParameterDBType,
	                                    CHARACTER_MAXIMUM_LENGTH Length,
	                                    NUMERIC_PRECISION xprec,
	                                    NUMERIC_SCALE scale,
	                                    case when PARAMETER_MODE like '%OUT%' then 1
		                                    else 0
		                                    end IsOutParam,
		                                1 IsNullable,
	                                    0 is_readonly, 
