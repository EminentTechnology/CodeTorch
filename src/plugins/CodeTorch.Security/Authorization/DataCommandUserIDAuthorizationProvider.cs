...
{
    public class DataCommandUserIDAuthorizationProvider : IAuthorizationProvider
    {
        DataCommandService sql = DataCommandService.GetInstance();

        private const string DataCommandUserGetPermissions = "User_GetPermissionsByUserID";
        private const string DataCommandRoleGetByUserAndRoleName = "Role_GetByUserIDAndRoleName";
        ...
        private const string ParameterUserName = "@UserID";
